...
//           <span className="font-bold">MoortiMahal</span>
//         </Link>
//         <Sheet>
//           <SheetTrigger asChild>
...
//             </Button>
//           </SheetTrigger>
//           <SheetContent side="left" className="w-full max-w-xs pl-4 py-4">
//             <MenuItems />
//             <HeaderRightContent />
//           </SheetContent>
//         </Sheet>
      ...
      <Sheet open={openCartSheet} onOpenChange={setOpenCartSheet}>
        <SheetTrigger asChild>
          ...
          >
            ...
            <span className={`absolute ${isMobile ? 'top-[-8px] right-2' : 'top-[-5px] right-[2px]'} font-bold text-xs bg-primary text-primary-foreground rounded-full w-5 h-5 flex items-center justify-center`}>
              {cartItems?.items?.length || 0}
            </span>
            <span className="sr-only">User cart</span>
          </Button>
